...
@IBDesignable open class HoshiTextField: TextFieldEffects {
    ...
    */
    @IBInspectable dynamic open var placeholderFontScale: CGFloat = 0.99 {
        didSet {
            updatePlaceholder()
        }
    }

    @IBInspectable dynamic open var placeholderFontScaleActive: CGFloat = 0.65 {
        didSet {
            updatePlaceholder()
        }
    }
    ...
    //    placeholderLabel.font = placeholderFontScaleActive as! UIFont
        layoutPlaceholderInTextRect()
