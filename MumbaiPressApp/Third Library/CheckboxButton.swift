...
open class CheckboxButton: UIButton {
    ...
    @IBInspectable open var checkLineWidth: CGFloat = 2.5 {
        didSet {
            layoutLayers()
        }
    }
    ...
    /// Default value is 2.
    @IBInspectable open var containerLineWidth: CGFloat = 1.5 {
        didSet {
            layoutLayers()
        }
    }
    ...
    /// Default value is `false`.
    @IBInspectable open var containerFillsOnToggleOn: Bool = true {
        didSet {
            colorLayers()
        }
    }
...
//            checkLayer.strokeColor = checkColor.cgColor
            ...
            containerLayer.fillColor = UIColor(red:0.09, green:0.46, blue:0.82, alpha:1.0).cgColor
           // containerLayer.fillColor = containerFillsOnToggleOn ? containerColor.cgColor : UIColor.blue.cgColor
            checkLayer.strokeColor = checkColor.cgColor
        } else {
