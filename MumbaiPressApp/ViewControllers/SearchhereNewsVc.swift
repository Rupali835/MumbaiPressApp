...
class SearchhereNewsVc: UIViewController, TableViewDelegateDataSource, UISearchBarDelegate
{

    @IBOutlet weak var searchBar: UISearchBar!
    @IBOutlet weak var tblsearchnews: UITableView!
    var searchNewsArr = [AnyObject]()
  ...
  ////////*********     TABLEVIEW - METHODS     *******///////////
    ...
    {
        return self.searchNewsArr.count
    }
...
////////////*******      EXTRA - METHODS      ************////////
    ...
    func getSearchData(searchStr: String)
    {
        ...
        Alamofire.request(searchUrl, method: .get, parameters: nil).responseJSON { (resp) in
            ...
            self.searchNewsArr = resp.result.value as! [AnyObject]
            
            if self.searchNewsArr.count == 0
            {
