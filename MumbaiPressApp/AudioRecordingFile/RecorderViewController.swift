...
class RecorderViewController: UIViewController {
    ...
    var lcRecordCollection : RecordingsCollectionViewController!
    ...
    override func awakeFromNib() {
        self.lcRecordCollection = self.storyboard?.instantiateViewController(withIdentifier: "RecordingsCollectionViewController") as! RecordingsCollectionViewController
    ...
    @IBAction func record(_ sender: UIButton) {
        ...
        if recorder != nil && recorder.isRecording {
            print("pausing")
            recorder.pause()
            recordButton.setImage(#imageLiteral(resourceName: "stop1"), for: .normal)
    ...
    @IBAction func stop(_ sender: UIButton) {
        ...
        recordButton.setImage(#imageLiteral(resourceName: "play"), for: .normal)
  //      recordButton.setTitle("Record", for: .normal)
    ...
    func setupRecorder() {
        ...
        self.recordingArr.append(self.soundFileURL)
...
//                    print("removing \(path)")
    ...
    @IBAction func btnShowRecording_Click(_ sender: Any)
    {
        let lcappDelegate = UIApplication.shared.delegate as! AppDelegate
        let nvg = lcappDelegate.window?.rootViewController as! UINavigationController
        nvg.pushViewController(lcRecordCollection, animated: true)
    }
    
    @IBAction func btnCancel_Click(_ sender: Any)
    {
        delegate?.RecordingData(RecordArr: self.recordingArr)
...
extension RecorderViewController: AVAudioRecorderDelegate {
    ...
    func audioRecorderDidFinishRecording(_ recorder: AVAudioRecorder,
        ...
        alert.addAction(UIAlertAction(title: "Keep", style: .default) {[unowned self] _ in
            self.delegate?.RecordingData(RecordArr: self.recordingArr)
