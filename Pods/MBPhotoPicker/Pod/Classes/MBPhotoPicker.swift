  ...
  open func present(_ controller: UIViewController!) {
    ...
    if !self.disableEntitlements {
      let actionOther = UIAlertAction(title: self.localizeString(actionTitleOther), style: .default, handler: { (alert: UIAlertAction!) in
        ...
        let document = UIDocumentMenuViewController(documentTypes:[kUTTypeImage as String, kUTTypeSpreadsheet as String, kUTTypePresentation as String, kUTTypeDatabase as String, kUTTypeFolder as String, kUTTypeZipArchive as String, kUTTypeVideo as String, kUTTypePDF as String, kUTTypeText as String, kUTTypeContent as String, kUTTypeItem as String, kUTTypeMessage as String] , in: .import)
...
//    let widthRatio = size.width/2
//     let heightRatio = size.height/2
